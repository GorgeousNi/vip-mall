...
import com.vip.utils.annotation.JsonDes;
import java.lang.reflect.Field;

/**
 * Json 转换脱敏工具
 *
 * @author GorgeousNi on 2018/7/10 下午2:01
 */
public class JsonDesUtils {
   ...
   * @return 脱敏后的字符串
   */
  private static String desensitization(String value, int prefixLength, int suffixLength,
      int asteriskNum) {
